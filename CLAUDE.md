...
- **Encapsulate the "how" behind names that describe the "what."** Abstract implementation details behind well-named functions, modules, or files so consumers see intent, not mechanics. This applies at every level — shell functions, test assertions, file organization.
